...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Linlin Deng
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm full stack developer based in Brisbane, 
            and I'm very passionate and dedicated to programming.</p>
